...
public interface MiniJavaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MiniJavaParser#exp1}.
	 * @param ctx the parse tree
	 */
	void enterExp1(MiniJavaParser.Exp1Context ctx);
	/**
	 * Exit a parse tree produced by {@link MiniJavaParser#exp1}.
	 * @param ctx the parse tree
	 */
	void exitExp1(MiniJavaParser.Exp1Context ctx);
	/**
	 * Enter a parse tree produced by {@link MiniJavaParser#exp2}.
	 * @param ctx the parse tree
	 */
	void enterExp2(MiniJavaParser.Exp2Context ctx);
	/**
	 * Exit a parse tree produced by {@link MiniJavaParser#exp2}.
	 * @param ctx the parse tree
	 */
	void exitExp2(MiniJavaParser.Exp2Context ctx);
}